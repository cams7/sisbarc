...
public class MemberValidationTest {
    ...
    public static Archive<?> createTestArchive() {
        return ShrinkWrap.create(WebArchive.class, "web-test.war").addClasses(Member.class)
        // enable JPA
    ...
    public void testEmailViolation() {
        ...
        Assert.assertEquals("One violation was found", 1, violations.size());
        Assert.assertEquals("Email was invalid", "N\u00e3o \u00e9 um endere\u00e7o de e-mail", violations.iterator().next().getMessage());
    }
    ...
    public void testPhoneViolation() {
        ...
        Assert.assertEquals("One violation was found", 1, violations.size());
        Assert.assertEquals("Phone number was invalid", "tamanho deve estar entre 10 e 12", violations.iterator().next()
                .getMessage());
    }
